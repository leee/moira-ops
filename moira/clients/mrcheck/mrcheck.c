/* $Id: mrcheck.c,v 1.20.2.1 2002-08-14 21:30:17 zacheiss Exp $
 *
...
RCSID("$Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/clients/mrcheck/mrcheck.c,v 1.20.2.1 2002-08-14 21:30:17 zacheiss Exp $");
