/* $Id: utils.c,v 1.49.4.1 2002-08-14 21:30:14 zacheiss Exp $
 *
...
RCSID("$Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/clients/moira/utils.c,v 1.49.4.1 2002-08-14 21:30:14 zacheiss Exp $");
