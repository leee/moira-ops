/* $Id: menus.c,v 1.44.2.1 2001-08-22 08:37:59 zacheiss Exp $
 *
...
RCSID("$Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/clients/moira/menus.c,v 1.44.2.1 2001-08-22 08:37:59 zacheiss Exp $");
