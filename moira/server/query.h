/* $Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/server/query.h,v 2.3.2.4 1997-10-03 17:31:24 danw Exp $
 *
...
enum vo_type {V_NAME, V_ID, V_TYPE, V_TYPEDATA, V_RENAME,
	      V_CHAR, V_LEN, V_NUM};
