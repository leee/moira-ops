/* $Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/server/query.h,v 2.3.2.3 1997-10-02 00:24:25 danw Exp $
 *
...
enum vo_type {V_NAME, V_ID, V_TYPE, V_TYPEDATA,
	      V_RENAME, V_CHAR, V_WILD, V_UPWILD,
              V_LEN, V_NUM};
