/* $Id: mr_scall.c,v 1.38.4.1 2002-08-14 21:30:48 zacheiss Exp $
 *
 * Do RPC
 *
...
RCSID("$Header: /afs/.athena.mit.edu/astaff/project/moiradev/repository/moira/server/mr_scall.c,v 1.38.4.1 2002-08-14 21:30:48 zacheiss Exp $");
